...
<body>
    ...
    <form method="POST">
        <div class="container1"> <!-- Flight Type Selection-->
            <h3>Select Flight Type:</h3><br>
        ...
        <div class="container2"> <!-- Departure Location and Destination -->
        ...
        <div class="container3"> <!-- Departure Time -->
            <label for="depart_date">Departure Date:</label><br>
            <input class="date" type="date" name="depart_date" required><br>

            <!-- Return Date (Visible only for Round Trip) -->
            <div id="return_date_container" style="display: none;">
                <label for="return_date">Return Date:</label><br>
                <input class="date" type="date" id="return_date" name="return_date"><br>
            </div>
        </div>
